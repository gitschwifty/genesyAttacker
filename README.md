...
4. Note this will attack twice, assuming you already attacked once manually. Easy change to only attack once (remove the second `callContract` block) if needed
